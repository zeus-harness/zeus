...
resolve_capacity_alias() {
	local name="$1"
	local legacy_name="$2"
	local default="$3"
	local name_set=0
	local legacy_set=0
	declare -p "${name}" >/dev/null 2>&1 && name_set=1
	declare -p "${legacy_name}" >/dev/null 2>&1 && legacy_set=1
	if ((name_set == 1 && legacy_set == 1)); then
		printf '[zeus-container] error: %s and its legacy alias %s cannot both be set\n' \
			"${name}" "${legacy_name}" >&2
		return 1
	fi
	if ((name_set == 1)); then
		printf '%s\n' "${!name}"
	elif ((legacy_set == 1)); then
		printf '%s\n' "${!legacy_name}"
	else
		printf '%s\n' "${default}"
	fi
...
MAX_SESSIONS_PER_ACTOR="$(resolve_capacity_alias \
	ZEUS_MAX_SESSIONS_PER_ACTOR ZEUS_MAX_SESSIONS_PER_SCOPE 1000)"
MAX_SESSIONS_GLOBAL="${ZEUS_MAX_SESSIONS_GLOBAL-10000}"
MAX_SESSIONS_PER_ACCOUNT="${ZEUS_MAX_SESSIONS_PER_ACCOUNT-${MAX_SESSIONS_GLOBAL}}"
MAX_OPEN_TURNS_PER_ACTOR="$(resolve_capacity_alias \
	ZEUS_MAX_OPEN_TURNS_PER_ACTOR ZEUS_MAX_OPEN_TURNS_PER_SCOPE 32)"
MAX_OPEN_TURNS_GLOBAL="${ZEUS_MAX_OPEN_TURNS_GLOBAL-64}"
MAX_OPEN_TURNS_PER_ACCOUNT="${ZEUS_MAX_OPEN_TURNS_PER_ACCOUNT-${MAX_OPEN_TURNS_GLOBAL}}"
MAX_ACTIVE_REPLY_JOBS_PER_ACTOR="$(resolve_capacity_alias \
	ZEUS_MAX_ACTIVE_REPLY_JOBS_PER_ACTOR ZEUS_MAX_ACTIVE_REPLY_JOBS_PER_SCOPE 32)"
MAX_ACTIVE_REPLY_JOBS_GLOBAL="${ZEUS_MAX_ACTIVE_REPLY_JOBS_GLOBAL-64}"
MAX_ACTIVE_REPLY_JOBS_PER_ACCOUNT="${ZEUS_MAX_ACTIVE_REPLY_JOBS_PER_ACCOUNT-${MAX_ACTIVE_REPLY_JOBS_GLOBAL}}"
MAX_ACTIVE_DISPATCH_JOBS_PER_ACTOR="$(resolve_capacity_alias \
	ZEUS_MAX_ACTIVE_DISPATCH_JOBS_PER_ACTOR ZEUS_MAX_ACTIVE_DISPATCH_JOBS_PER_SCOPE 16)"
MAX_ACTIVE_DISPATCH_JOBS_GLOBAL="${ZEUS_MAX_ACTIVE_DISPATCH_JOBS_GLOBAL-32}"
MAX_ACTIVE_DISPATCH_JOBS_PER_ACCOUNT="${ZEUS_MAX_ACTIVE_DISPATCH_JOBS_PER_ACCOUNT-${MAX_ACTIVE_DISPATCH_JOBS_GLOBAL}}"
...
MAX_ACCOUNT_AUDIT_DETAIL_ROWS="${ZEUS_MAX_ACCOUNT_AUDIT_DETAIL_ROWS-4096}"
MAX_ACCOUNT_AUDIT_ROWS_PER_ACCOUNT="${ZEUS_MAX_ACCOUNT_AUDIT_ROWS_PER_ACCOUNT-8192}"
MAX_ACCOUNT_AUDIT_ROWS_GLOBAL="${ZEUS_MAX_ACCOUNT_AUDIT_ROWS_GLOBAL-32768}"
RESERVED_ACCOUNT_AUDIT_PROGRESS_ROWS_PER_ACCOUNT="${ZEUS_RESERVED_ACCOUNT_AUDIT_PROGRESS_ROWS_PER_ACCOUNT-64}"
RESERVED_ACCOUNT_AUDIT_PROGRESS_ROWS_GLOBAL="${ZEUS_RESERVED_ACCOUNT_AUDIT_PROGRESS_ROWS_GLOBAL-256}"
ACCOUNT_AUDIT_COMPACTION_BATCH="${ZEUS_ACCOUNT_AUDIT_COMPACTION_BATCH-64}"
...
start_api() {
	...
	container run \
		...
		--env "ZEUS_MAX_SESSIONS_PER_ACTOR=${MAX_SESSIONS_PER_ACTOR}" \
		--env "ZEUS_MAX_SESSIONS_PER_ACCOUNT=${MAX_SESSIONS_PER_ACCOUNT}" \
		--env "ZEUS_MAX_SESSIONS_GLOBAL=${MAX_SESSIONS_GLOBAL}" \
		--env "ZEUS_MAX_OPEN_TURNS_PER_ACTOR=${MAX_OPEN_TURNS_PER_ACTOR}" \
		--env "ZEUS_MAX_OPEN_TURNS_PER_ACCOUNT=${MAX_OPEN_TURNS_PER_ACCOUNT}" \
		--env "ZEUS_MAX_OPEN_TURNS_GLOBAL=${MAX_OPEN_TURNS_GLOBAL}" \
		--env "ZEUS_MAX_ACTIVE_REPLY_JOBS_PER_ACTOR=${MAX_ACTIVE_REPLY_JOBS_PER_ACTOR}" \
		--env "ZEUS_MAX_ACTIVE_REPLY_JOBS_PER_ACCOUNT=${MAX_ACTIVE_REPLY_JOBS_PER_ACCOUNT}" \
		--env "ZEUS_MAX_ACTIVE_REPLY_JOBS_GLOBAL=${MAX_ACTIVE_REPLY_JOBS_GLOBAL}" \
		--env "ZEUS_MAX_ACTIVE_DISPATCH_JOBS_PER_ACTOR=${MAX_ACTIVE_DISPATCH_JOBS_PER_ACTOR}" \
		--env "ZEUS_MAX_ACTIVE_DISPATCH_JOBS_PER_ACCOUNT=${MAX_ACTIVE_DISPATCH_JOBS_PER_ACCOUNT}" \
		...
		--env "ZEUS_MAX_ACCOUNT_AUDIT_DETAIL_ROWS=${MAX_ACCOUNT_AUDIT_DETAIL_ROWS}" \
		--env "ZEUS_MAX_ACCOUNT_AUDIT_ROWS_PER_ACCOUNT=${MAX_ACCOUNT_AUDIT_ROWS_PER_ACCOUNT}" \
		--env "ZEUS_MAX_ACCOUNT_AUDIT_ROWS_GLOBAL=${MAX_ACCOUNT_AUDIT_ROWS_GLOBAL}" \
		--env "ZEUS_RESERVED_ACCOUNT_AUDIT_PROGRESS_ROWS_PER_ACCOUNT=${RESERVED_ACCOUNT_AUDIT_PROGRESS_ROWS_PER_ACCOUNT}" \
		--env "ZEUS_RESERVED_ACCOUNT_AUDIT_PROGRESS_ROWS_GLOBAL=${RESERVED_ACCOUNT_AUDIT_PROGRESS_ROWS_GLOBAL}" \
		--env "ZEUS_ACCOUNT_AUDIT_COMPACTION_BATCH=${ACCOUNT_AUDIT_COMPACTION_BATCH}" \
