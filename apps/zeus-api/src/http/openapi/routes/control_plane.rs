...
pub(crate) const ROUTES: &[PublicRoute] = &[
    public_route(
        ...
        200,
        None,
        BodySchema::Object("ModelConnectionTestResponse"),
        true,
    ),
    public_route(
        ...
        200,
        None,
        BodySchema::Object("PlatformUserPageResponse"),
        true,
    ),
    public_route(
    ...
    public_route(
        ...
        200,
        None,
        BodySchema::Array("PlatformOrganizationResponse"),
        true,
    ),
    public_route(
        "/api/v1/platform/organizations",
        ...
        "platform",
        201,
        Some("CreatePlatformOrganizationRequest"),
        BodySchema::Object("CreatedPlatformOrganizationResponse"),
        true,
    ),
    public_route(
        ...
        200,
        None,
        BodySchema::Object("PlatformOrganizationResponse"),
        true,
    ),
    public_route(
        "/api/v1/platform/organizations/{organization_id}",
        ...
        "platform",
        200,
        Some("UpdatePlatformOrganizationRequest"),
        BodySchema::Object("PlatformOrganizationMutationResponse"),
        true,
    ),
    public_route(
        ...
        "platform",
        200,
        Some("TransitionPlatformOrganizationRequest"),
        BodySchema::Object("PlatformOrganizationMutationResponse"),
        true,
    ),
    public_route(
        ...
        202,
        None,
        BodySchema::Object("PlatformOwnerInvitationResponse"),
        true,
    ),
    public_route(
        ...
        "platform",
        202,
        Some("ReplacePlatformOwnerInvitationRequest"),
        BodySchema::Object("PlatformOwnerInvitationResponse"),
        true,
    ),
    public_route(
        ...
        "platform",
        201,
        Some("CreatePlatformTenantAccessGrantRequest"),
        BodySchema::Object("PlatformTenantAccessGrantResponse"),
        true,
    ),
    public_route(
