...
use crate::{
    ...
    execution_api, experiences, integrations, native_auth, native_identity, organization,
...
#[openapi(
    ...
    components(schemas(
        ...
        organization::OidcProviderResponse,
        organization::CreateOidcProviderRequest,
        organization::UpdateOidcProviderRequest,
        organization::OidcGroupMappingResponse,
        organization::CreateOidcGroupMappingRequest,
...
pub const PUBLIC_ROUTES: &[PublicRoute] = &[
    ...
    public_route(
        ...
        200,
        None,
        BodySchema::Array("OidcProviderResponse"),
        true,
    ),
    public_route(
        "/api/v1/organizations/{organization_id}/oidc-providers",
        ...
        "organization",
        201,
        Some("CreateOidcProviderRequest"),
        BodySchema::Object("OidcProviderResponse"),
        true,
    ),
    public_route(
        ...
        "organization",
        200,
        Some("UpdateOidcProviderRequest"),
        BodySchema::Object("OidcProviderResponse"),
        true,
    ),
    public_route(
        ...
        200,
        None,
        BodySchema::Array("OidcGroupMappingResponse"),
        true,
    ),
    public_route(
        "/api/v1/organizations/{organization_id}/oidc-providers/{provider_id}/group-mappings",
        ...
        "organization",
        201,
        Some("CreateOidcGroupMappingRequest"),
        BodySchema::Object("OidcGroupMappingResponse"),
        true,
    ),
    public_route(
...
impl Modify for OpenApiModifier {
    fn modify(&self, openapi: &mut utoipa::openapi::OpenApi) {
        ...
        mark_write_only(components, "CreateOidcProviderRequest", "client_secret");
        mark_write_only(components, "UpdateOidcProviderRequest", "client_secret");
