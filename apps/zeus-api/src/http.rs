...
async fn metrics(State(state): State<AppState>) -> String {
    format!(
        ...
        state.metrics.identity_password_failures(),
        state.metrics.identity_mfa_failures(),
        state.metrics.identity_throttled(),
        state.metrics.identity_email_backlog(),
        state.metrics.identity_email_oldest_pending_age_seconds(),
        state.metrics.identity_operational_metrics_up(),
        state.metrics.federated_provider_errors(),
        state.metrics.oidc_refresh_replays(),
        state.metrics.oidc_signing_key_present(),
        state.metrics.oidc_signing_key_age_seconds(),
    )
}
