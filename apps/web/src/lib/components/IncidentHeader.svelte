<script lang="ts">
	...
	let { incident, run, source, streamStatus, onToggleNav }: Props = $props();
...
<header class="border-zeus-border bg-white px-4 sm:px-6 h-16 flex shrink-0 items-center border-b">
