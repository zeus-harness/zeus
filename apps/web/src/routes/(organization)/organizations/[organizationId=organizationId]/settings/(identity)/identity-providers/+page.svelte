                ...
                <details class="edit-details">
                  ...
                  <form method="POST" action="?/update" class="form-stack compact-form">
                    ...
                    <div class="field">
                      ...
                      <Textarea id={`provider-acr-${provider.id}`} name="trusted_acr" rows={2} value={provider.trusted_acr.join(', ')} />
                    </div>
                    <div class="field">
                      <label for={`provider-amr-${provider.id}`}>Trusted AMR</label>
                      <Textarea id={`provider-amr-${provider.id}`} name="trusted_amr" rows={2} value={provider.trusted_amr.join(', ')} />
                    </div>
