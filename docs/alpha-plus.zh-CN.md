...
`send_message@1-direct-child-followup` 与只读 `list_agents@1-direct-session-forks`、
...
盲目重发。当前阶段尚不提供 interrupt 或递归全图加载。
...
- host 按项目既有统计口径通过 699 个 Rust 测试（authz 7、connectors 22、deployment 8、
  execution 16、goals 4、kernel 10、knowledge 29、LLM unit 30、provider contract 18、planning 4、
  protocol 21、runtime 52、skills 5、subagents 10、storage 286、tenancy 15、terminal 10、tools 16、
  workflows 21、API library 96、API main/config 18、graceful shutdown 1）与 28 个 Web Node 测试。
